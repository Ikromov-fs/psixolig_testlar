<template>
  <div class="bg-[#AFEEEE] py-5 mmd:pb-10">
    <div
      class="container grid sx:grid-cols-1 ss:grid-cols-2 mmd:grid-cols-4 sx:text-center gap-5 mmd:text-left text-black font-[600]"
    >
      <ul>
        <li>
          <img
            :src="logo"
            alt="iconka sayt"
            class="sx:mx-auto mmd:m-0 max-w-[100px]"
          />
        </li>
      </ul>
      <ul class="flex flex-col gap-1">
        ...
        <li class="cursor-pointer hover:text-[#fdf001]">
          ...
          <a
            target="_blank"
            href="https://www.youtube.com/@PsixologRozaliyaGabdulhakova"
            >Youtube</a
          >
        </li>
      </ul>
